...
/**
 * Compact relative label from an ISO string. Past-only ladder that keeps
 * climbing in days indefinitely (never falls back to an absolute date, unlike
 * formatDate('relative') which stops at 7d). Lowercase "just now" leader.
 */
