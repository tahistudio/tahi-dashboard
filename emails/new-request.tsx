...
export function NewRequestEmail({
  ...
  return (
    <Html>
      <Head />
      <Preview>New request submitted: {requestTitle}</Preview>
        ...
        <Container style={containerStyle}>
          ...
          <Section style={contentStyle}>
            ...
            <Text style={textStyle}>
              A new request has been submitted{submittedBy ? ` by ${submittedBy}` : ''}.
            </Text>
            ...
            <Section style={detailsBoxStyle}>
              ...
              {category && (
                <>
                  ...
                  <Text style={detailValueStyle}>{category}</Text>
                </>
              )}

              {priority && (
                <>
                  <Text style={detailLabelStyle}>Priority</Text>
                  <Text style={detailValueStyle}>{priority}</Text>
                </>
              )}
            </Section>
