import { AnimatedSettings } from 'tahi-dashboard'
...
export const NavButton = () => (
  <div style={{ padding: '1.25rem', background: 'var(--color-bg)', display: 'flex', gap: '0.5rem' }}>
    <button style={{
      ...
      <AnimatedSettings size={16} color="var(--color-brand)" />
      Settings
    </button>
    <button style={{
      display: 'inline-flex', alignItems: 'center', gap: '0.5rem',
      ...
      <AnimatedSettings size={16} color="#fff" />
      Configure
    </button>
  </div>
)
