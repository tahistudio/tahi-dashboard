import { AnimatedEye } from 'tahi-dashboard'
...
export const ViewButton = () => (
  <div style={{ padding: '1.25rem', background: 'var(--color-bg)', display: 'flex', gap: '0.5rem' }}>
    <button style={{
      ...
      <AnimatedEye size={15} color="var(--color-brand)" />
      Preview
    </button>
    <button style={{
      display: 'inline-flex', alignItems: 'center', gap: '0.5rem',
      ...
      color: 'var(--color-text-muted)', fontSize: '0.875rem', fontFamily: 'Manrope, sans-serif',
      cursor: 'pointer',
    }}>
      <AnimatedEye size={15} color="var(--color-text-muted)" />
      Client view
    </button>
  </div>
)
