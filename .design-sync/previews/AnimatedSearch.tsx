import { AnimatedSearch } from 'tahi-dashboard'
...
export const SearchInput = () => (
  <div style={{ padding: '1.25rem', background: 'var(--color-bg)' }}>
    <div style={{
      ...
      <AnimatedSearch size={16} color="var(--color-text-subtle)" />
      <span style={{ fontSize: '0.875rem', color: 'var(--color-text-subtle)', fontFamily: 'Manrope, sans-serif' }}>
        Search clients, requests...
      </span>
    </div>
  </div>
)
