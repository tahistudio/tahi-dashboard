...
const VARIANTS = {
  primary:   'bg-[var(--color-brand)] text-white hover:bg-[var(--color-brand-dark)] hover:shadow-[0_4px_14px_rgba(90,130,78,0.4)] hover:-translate-y-px active:translate-y-0 active:shadow-none',
  ...
  danger:    'bg-[var(--color-danger)] text-white hover:shadow-[0_4px_14px_rgba(220,38,38,0.4)] hover:-translate-y-px active:translate-y-0 active:shadow-none',
}
