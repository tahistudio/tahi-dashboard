...
- [~] LW.39 - Calls: two more meeting types, mentoring and other (Liam, 2026-09-19), everywhere the vocabulary is used; the calendar sync keeps a hand-set type. In flight as workflow call-types-mentoring-other.
