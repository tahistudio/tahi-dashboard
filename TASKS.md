...
- [ ] CR.4 - [FE] Mobile touch polish from the live checks (row title buttons 38px, hero actions 28px, card CTAs 36px, breadcrumb 21px at 375px; hero overflow button orphaned on its own line) in flight.
