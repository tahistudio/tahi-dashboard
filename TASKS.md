...
- [~] CN.1b - [BE/FE/MCP] Suggestions become requests as well as tasks (Liam, 2026-09-19: these are tasks and requests, especially requests from a client). Kinds create_request, update_request, request_note, hand_off_request; the Tasks vs Requests rule in the prompt; request writes extracted like the task writes; a rebuild route to re-read the eight calls. Contract docs/superpowers/plans/2026-09-19-cn1b-requests-contract.md; in flight as workflow cn1b-requests-build.
