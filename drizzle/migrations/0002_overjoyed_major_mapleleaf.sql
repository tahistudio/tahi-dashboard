...
CREATE INDEX IF NOT EXISTS `idx_contracts_org` ON `contracts` (`org_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_conv_participants_conv` ON `conversation_participants` (`conversation_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_steps_request` ON `request_steps` (`request_id`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_steps_parent` ON `request_steps` (`parent_step_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_calls_org` ON `scheduled_calls` (`org_id`);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_calls_scheduled` ON `scheduled_calls` (`scheduled_at`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS `idx_tma_member` ON `team_member_access` (`team_member_id`);--> statement-breakpoint
CREATE TABLE IF NOT EXISTS `team_member_access_orgs` (
