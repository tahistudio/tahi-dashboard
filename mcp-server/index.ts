...
server.tool(
  ...
  'Update a client organisation',
  {
    ...
    customMrr: z.number().optional().describe('Monthly recurring revenue in the org preferredCurrency'),
    billingModel: z.string().optional().describe('retainer | hourly | project | none'),
    retainerStartDate: z.string().optional().describe('YYYY-MM-DD when retainer began'),
    retainerEndDate: z.string().optional().describe('YYYY-MM-DD when retainer ends (churn date). Cash flow stops counting this client after this date.'),
    ...
    defaultHourlyRate: z.number().optional().describe('Default hourly rate for this client (what we charge them)'),
