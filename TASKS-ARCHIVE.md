# tahi-dashboard — Task Archive

Full historical task list. Split from TASKS.md on 2026-05-21.
Active items live in `TASKS.md`. This file is the grep history for closed work + the full Phase 1-10 narrative.
